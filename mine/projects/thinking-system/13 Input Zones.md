...
**What goes in:** questions you want the wiki to answer, one per line with the date. Add them whenever they occur to you, especially while reading what an ingest produced.
...
**What `/ask` does:** takes the oldest unanswered question, reads `index.md` and the relevant pages, answers with links and citations, then asks whether to file the answer as an analysis page. It ticks the question off in the zone file.

## 4. Zone 3: checks → `/lint`
**What goes in:** anything you want verified or re-examined. A page that felt thin, a claim you doubt, a topic you suspect has gaps.
**What `/lint` does:** runs the standing checks from [[03 Trust and Provenance]] — contradictions, superseded claims, uncited claims, orphan pages, missing concept pages, pages not updated in six months — and then works through your queued checks. It writes a dated report in `system/lint/` and changes nothing without your approval.
**Rhythm:** weekly, as part of the review in [[05 Learning Path]] Stage 7.
...
- **Away from the PC:** a chat in the "Obsidian x Claude" Project can't reach the vault. Use it to think and to draft, then paste anything worth keeping into the right zone at your next local session. Treat the Project chat as a fourth, informal zone with no automation behind it.
