...
| 1.14 | 2026-09-22 | Source 1 committed. The `raw/` deny rule blocked Claude's shell move, so the move becomes yours, with the command given in the skill's first message (D-045, proposed). Docs 06, 07, 08 and 13 updated |
