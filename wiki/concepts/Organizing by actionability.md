...
Organising information by the projects and goals you are committed to now, not by broad subjects. Forte gives it as the key principle of the PARA method ([[raw/forte-para-method.md]]).

## What the sources say
- Filing by academic subject ("Math", "History") is a habit from school. As adults we keep doing it with broad categories like "Marketing" or "Psychology", which "makes zero sense" at work ([[raw/forte-para-method.md]]).
...
- **With the compiled wiki.**
  ...
  - This is an open point, not a disagreement.

## Where sources disagree
- **What notes should be organised around.**
